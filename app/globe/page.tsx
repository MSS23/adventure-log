...
import EnhancedGlobe from "@/components/globe/enhanced-globe";
            ...
            <div className="space-y-4">
              ...
              {allPinsForGlobe.length === 0 && (
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="mb-4">
                    Your albums need location coordinates to appear on the
                    globe.
                  </p>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2">
                  ...
                  Travel Pins ({filteredPinsForList.length} of{" "}
                  {allPinsForGlobe.length})
                </CardTitle>
                <div className="flex items-center gap-2">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t">
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>
                    Showing {filteredPinsForList.length} of{" "}
                    {allPinsForGlobe.length} travel locations
                  </span>
