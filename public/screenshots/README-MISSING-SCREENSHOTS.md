# MISSING PWA SCREENSHOTS - REQUIRED FOR APP STORE LISTINGS

## ⚠️ IMPORTANT: These screenshots are needed for proper PWA app store listings

The manifest.json references these screenshots for PWA installation prompts and app store listings.
...
- **Mobile**: Portrait orientation (390x844)
- **Desktop**: Landscape orientation (1920x1080)
- **Content**: Real-looking data, not placeholders
- **UI**: Show actual app interface, not mockups

## How to Create:

1. **Run the application locally**
2. **Create sample travel data** (albums with locations)
3. **Take screenshots** using browser dev tools:
