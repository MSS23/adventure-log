...
export default function DashboardContent({
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      log.error('Error fetching profile stats', { component: 'DashboardContent', userId }, err instanceof Error ? err : new Error(String(err)))
    } finally {
      setLoading(false)
    }
  }, [userId])
    ...
    <div className="space-y-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              <div>
                ...
                {profile.display_name && profile.username && (
                  <p className="text-stone-500 dark:text-stone-500 text-sm mt-0.5">@{profile.username}</p>
                )}
              </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold tracking-tight text-stone-900 dark:text-stone-100">Recent Albums</h2>
