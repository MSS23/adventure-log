            ...
            {(['all', 'draft', 'published', 'archived'] as const).map((status, index) => (
              <motion.button
                ...
                className={cn(
                  ...
                  filter === status
                    ? "bg-gradient-to-r from-amber-500/10 to-orange-500/10 text-amber-700 border border-amber-200 shadow-sm"
            ...
            <AnimatePresence mode="popLayout">
              {itineraries.map((itinerary) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline decoration */}
                    <div className="absolute left-6 top-24 bottom-32 w-0.5 bg-gradient-to-b from-amber-500 via-orange-400 to-transparent opacity-30 group-hover:opacity-60 transition-opacity" />

                    {/* Header */}
                    <div className="p-5 border-b border-stone-100/50">
                      <div className="flex items-start justify-between mb-3">
                        <h3 className="font-bold text-lg text-stone-900 line-clamp-2 group-hover:text-amber-700 transition-colors">
                          {itinerary.title}
                        </h3>
                        <motion.button
                          onClick={(e) => {
                      ...
                      <div className="flex items-center gap-2 text-sm text-stone-600">
                        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-amber-100 to-orange-100 flex items-center justify-center">
                    ...
                    <div className="p-5 relative">
                            ...
                            >
                              <div className="relative">
                                <div className={cn(
                                  ...
                                  i === 0 ? "bg-amber-500" : i === 1 ? "bg-orange-400" : "bg-amber-300"
                                )} />
                      ...
                      <div className="flex gap-2">
                        <Link href={`/itineraries/${itinerary.id}`} className="flex-1">
                          ...
                          >
                            <Button variant="outline" className="w-full gap-2 border-stone-200 hover:border-amber-200 hover:bg-amber-50/50 hover:text-amber-700 transition-all rounded-xl">
