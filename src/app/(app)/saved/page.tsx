        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <motion.div
                className="w-10 h-10 rounded-xl bg-gradient-to-br from-olive-100 to-pink-100 flex items-center justify-center"
                whileHover={prefersReducedMotion ? {} : { scale: 1.1, rotate: 5 }}
                transition={{ type: 'spring', stiffness: 400, damping: 20 }}
              >
                <Bookmark className="h-6 w-6 text-olive-600" />
              </motion.div>
              <div>
              ...
              {savedAlbums.map((album) => (
                ...
                >
                  <Link href={`/albums/${album.id}`}>
                    ...
                    {/* Album Info */}
                    <div className="p-4">
                      <h3 className="font-semibold text-stone-900 truncate mb-1 group-hover:text-olive-600 transition-colors">
                        {album.title}
                      </h3>
