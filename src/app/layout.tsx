...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://roamkeep.net'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    locale: 'en_US',
    url: '/',
    title: 'Roamkeep — Keep the places that made you',
  ...
  applicationName: 'Roamkeep',
  generator: 'Next.js',
  other: {
    'mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-capable': 'yes',
    'application-name': 'Roamkeep',
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                // Roamkeep is light-only. Force light before first paint so
