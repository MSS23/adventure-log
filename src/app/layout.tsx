...
export const metadata: Metadata = {
  ...
  description: "See your travels on a 3D globe. Create photo albums, watch cinematic flyover reels, build your travel passport, and share your journey with the world. Free to start.",
  keywords: [
    "travel",
    "adventure",
    "journeys",
  ...
  twitter: {
    ...
    title: 'Adventure Log - Your Travel Story',
    description: 'See your travels on a 3D globe. Create albums, watch flyover reels, and share your travel passport.',
    site: '@adventurelog',
