...
export const metadata: Metadata = {
  ...
  description: "Build your travel globe, connect passports, and compare where your journeys cross. Share albums and cinematic flyovers with privacy-safe travel seasons. Free to start.",
  keywords: [
    "travel",
    "adventure",
    "journeys",
  ...
  openGraph: {
    ...
    description: 'Build your travel globe, connect passports, and compare where your journeys cross — with privacy-safe travel seasons instead of exact dates.',
  ...
  twitter: {
    ...
    title: 'Adventure Log - Your Travel Story',
    description: 'Build a 3D travel globe, compare it with friends, and share privacy-safe flyover reels.',
    site: '@adventurelog',
