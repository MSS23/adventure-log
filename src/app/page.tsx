        ...
        <footer className="py-12 px-6 lg:px-10 border-t border-white/[0.04]">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex gap-6 text-sm text-stone-500">
              ...
              <Link href="/dmca" className="hover:text-white transition-colors duration-200 focus-visible:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-olive-500 rounded-sm">DMCA</Link>
