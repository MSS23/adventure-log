                ...
                {group.photos.map((photo) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 flex items-center justify-center bg-black/70 hover:bg-black text-white rounded-full p-1.5 opacity-0 group-hover:opacity-100 pointer-coarse:opacity-100 pointer-coarse:p-0 pointer-coarse:h-9 pointer-coarse:w-9 pointer-coarse:after:content-[''] pointer-coarse:after:absolute pointer-coarse:after:-inset-1 transition-all duration-200 cursor-pointer hover:scale-110 active:scale-90 outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                    >
                      <X className="h-3 w-3" />
                    </button>
