  ...
  const achievements: Achievement[] = [
    {
      ...
      unlocked: stats.totalAlbums >= 1,
      progress: Math.min(stats.totalAlbums, 1),
      requirement: 1,
      category: 'milestone',
      rarity: 'common'
    },
    {
      ...
      icon: <Camera className="h-4 w-4" />,
      unlocked: stats.totalPhotos >= 100,
    ...
    },
    {
      ...
      unlocked: stats.countriesVisited >= 10,
      progress: Math.min(stats.countriesVisited, 10),
      requirement: 10,
      category: 'travel',
      rarity: 'epic'
    },
    {
      ...
      unlocked: stats.citiesExplored >= 25,
      progress: Math.min(stats.citiesExplored, 25),
      requirement: 25,
      category: 'travel',
      rarity: 'epic'
    },
    {
      ...
      unlocked: stats.totalAlbums >= 20,
      progress: Math.min(stats.totalAlbums, 20),
      requirement: 20,
      category: 'milestone',
      rarity: 'rare'
    },
