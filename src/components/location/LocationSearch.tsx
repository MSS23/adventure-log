      ...
      <div className="space-y-2">
        <div className="flex gap-2">
          <div className="relative flex-1">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-stone-700 dark:text-stone-300" />
            <Input
              ref={inputRef}
              type="text"
              value={query}
        ...
        {error && (
          <div className="flex items-start gap-2 p-2 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/40 rounded text-sm text-red-600">
            ...
            {results.map((result) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <MapPin className="h-4 w-4 text-stone-700 dark:text-stone-300 mt-0.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-stone-900 dark:text-stone-100 line-clamp-1">
      ...
      {showResults && results.length === 0 && query.length >= 3 && !isSearching && (
        <Card className="absolute top-full left-0 right-0 z-50 mt-1">
          <CardContent className="p-4 text-center">
            <p className="text-stone-800 dark:text-stone-200">No locations found for &quot;{query}&quot;</p>
            <p className="text-sm text-stone-800 dark:text-stone-200 mt-1">Try a different search term</p>
          </CardContent>
        </Card>
      )}
    </div>
