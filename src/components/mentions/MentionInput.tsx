  ...
  return (
    <div className="relative">
      <textarea
        ...
        rows={rows}
        className={`
          w-full px-3 py-2 rounded-xl border border-border bg-card text-sm text-foreground
      ...
      {maxLength && (
        <div className="text-xs font-mono tracking-wide text-muted-foreground mt-1 text-right">
