...
export function UserSuggestionDropdown({
  ...
  if (isLoading) {
    return (
      <div className="absolute z-50 w-64 mt-1 bg-white border border-stone-200 rounded-lg shadow-lg py-2">
  ...
  return (
    <div className="absolute z-50 w-64 mt-1 bg-white border border-stone-200 rounded-lg shadow-lg py-2 max-h-60 overflow-y-auto">
