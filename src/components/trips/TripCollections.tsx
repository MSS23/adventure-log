      ...
      <CardContent>
        <div className="space-y-4">
          {trips.map((trip, index) => (
            <div
              key={trip.id}
              className="group relative bg-gradient-to-br from-white to-stone-50 rounded-xl border-2 border-stone-100 hover:border-olive-200 hover:shadow-lg transition-all duration-300 overflow-hidden"
            >
              <div className="flex gap-4">
                ...
                <div className="flex-1 p-4 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-stone-900 text-lg truncate group-hover:text-olive-600 transition-colors">
                        {trip.name}
                      </h3>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {trip.albums.slice(0, 3).map((album) => (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 px-2 py-1 bg-olive-50 hover:bg-olive-100 rounded-md text-xs font-medium text-olive-700 transition-colors"
                      >
                        {album.title}
                      </Link>
                    ))}
                ...
                <div className="flex items-center pr-4">
                  <ChevronRight className="h-5 w-5 text-stone-400 group-hover:text-olive-600 group-hover:translate-x-1 transition-all" />
                </div>
              </div>
            </div>
          ))}
