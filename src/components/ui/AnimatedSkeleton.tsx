...
export function AnimatedSkeleton({ className, variant = 'default' }: SkeletonProps) {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden bg-stone-200 dark:bg-white/[0.08]",
        className
      )}
      style={{ borderRadius }}
    >
...
export function CardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn("bg-white dark:bg-[#1B170E] rounded-2xl border border-stone-100 dark:border-white/[0.08] overflow-hidden", className)}>
...
export function FeedItemSkeleton({ className }: { className?: string }) {
  return (
    <motion.div
      className={cn(
        "bg-white dark:bg-[#1B170E] rounded-lg overflow-hidden border border-stone-200 dark:border-white/[0.10]",
        className
      )}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
  ...
  return (
    ...
    >
      {Array.from({ length: count }).map((_, i) => (
        <motion.div
          key={i}
          className="flex items-center gap-4 p-4 bg-white dark:bg-[#1B170E] rounded-xl border border-stone-100 dark:border-white/[0.08]"
          variants={{
